...
public class King : ChessPiece
{
    ...
    public override SpecialMove GetSpecialMoves(ref ChessPiece[,] board, ref List<Vector2Int[]> moveList, ref List<Vector2Int> availableMoves)
    {
        ...
        var kingMove = moveList.Find(m => m[0].x == 4 && m[0].y == ((team == 0) ? 0 : 7)); //this statement checks the if starting position of the king for both teams (y axis 0 & 7) is defined as a 'previousMove' in moveList.  If either of these show up as a previous move, that value will be returned here.  if the King has never been moved then we have a KingMove (value will be null).
